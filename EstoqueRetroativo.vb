...
Public Class EstoqueRetroativo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.EstoqueRetroativo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstoqueRetroativo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstoqueRetroativo = New EstoqueRetroativo()
        rpt.Site = Me.Site
        Return rpt
    End Function
