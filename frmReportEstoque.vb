...
Public Class frmReportEstoque
    ...
    Private Sub frmReportEstoque_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cn = GetConnection()
        sql(0) = "SELECT * FROM qLOTES_SERVICO_RETIRADA ORDER BY LOTE ASC"
        Dim cmi As New OleDbCommand(sql(0), cn)
        da = New OleDbDataAdapter(cmi)
        da.Fill(ds, "qLOTES_SERVICO_RETIRADA")
        oReport.Load(caminhoreport & "Estoque.rpt")
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        'sql(0) = "SELECT * FROM qLOTES_SERVICO_RETIRADA WHERE LOTE like '" & txtLote.Text & "*' ORDER BY LOTE ASC"
        'Dim cmi As New OleDbCommand(sql(0), cn)
        'da = New OleDbDataAdapter(cmi)
        'da.Fill(ds, "qLOTES_SERVICO_RETIRADA")
        ...
        Me.CRVEstoque.SelectionFormula = "{qLOTES_SERVICO_RETIRADA.LOTE} LIKE '*" & txtLote.Text & "*'"
        '**************** BUSCA NOME DA EMPRASA ****************************
        'sql(1) = "SELECT RAZAO FROM DADOSEMPRESA"
        'If cn.State = 0 Then cn.Open()
        'Dim cmu As New OleDbCommand(sql(1), cn)
        ...
        'End If
        '*********************************************************************
        Me.CRVEstoque.RefreshReport()
        Me.CRVEstoque.Refresh()
    ...
    Private Sub Estoque_InitReport(sender As System.Object, e As System.EventArgs) Handles Estoque.InitReport
