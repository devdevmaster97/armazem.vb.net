...
Friend Class frmSenhas
    Inherits System.Windows.Forms.Form
    Dim altera As Boolean
    Dim tabela_db As String = "USUARIOS"
    Dim ds As New DataSet
    Dim da As New OleDbDataAdapter
    Dim dt As New DataTable
    Dim dr As DataRow
    Private Sub frmSenhas_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSalvar.Click
        If txtNome.Text = "" Then
            MsgBox("Informe o nome", MsgBoxStyle.Information)
            txtNome.Focus()
        ...
        Else
            ...
            Else
                ...
                MsgBox("Dados cadastrados com sucesso!", MsgBoxStyle.Information, fabricante)
                altera = True
            End If
            estadobotao("exibido")
            habilita(Me, False)
    ...
    Private Sub cmdConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConsultar.Click
        '*******************************PARAMETROS DA BUSCA***************************
        Busca.Criterio = New TCriterio(2) {}
        Busca.Ncolunas = 2
        Busca.NumCrite = 0
    ...
    Private Sub cmdExcluir_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdExcluir.Click
        ...
        If resp = vbYes Then
            ...
            Else
                MessageBox.Show("Você nao pode excluir o usuário adminitrador!", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
        End If
    End Sub
    ...
    Private Sub Visualizando()
        If Not IsDBNull(dr("nome")) Then txtNome.Text = dr("nome")
        If Not IsDBNull(dr("senha")) Then txtSenha.Text = dr("senha")
    End Sub
    Private Sub Alterando()
        dr.BeginEdit()
        If txtNome.Text <> "" Then dr("nome") = txtNome.Text
        If txtSenha.Text <> "" Then dr("senha") = txtSenha.Text
        dr.EndEdit()
    End Sub
