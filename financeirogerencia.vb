...
Public Class financeirogerencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.financeirogerencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfinanceirogerencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As financeirogerencia = New financeirogerencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
