...
Public Class FichaEntrada_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.FichaEntrada_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_insc() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFichaEntrada_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FichaEntrada_old = New FichaEntrada_old()
        rpt.Site = Me.Site
        Return rpt
    End Function
