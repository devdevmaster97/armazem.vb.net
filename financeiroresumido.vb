...
Public Class financeiroresumido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.financeiroresumido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfinanceiroresumido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As financeiroresumido = New financeiroresumido()
        rpt.Site = Me.Site
        Return rpt
    End Function
