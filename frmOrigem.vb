...
Friend Class frmOrigem
    Inherits System.Windows.Forms.Form
    Dim altera As Boolean
    Dim tabela_db As String = "ORIGEM"
    Dim ds As New DataSet
    Dim da As New OleDbDataAdapter
    Dim dt As New DataTable
    Dim dr As DataRow
    Private Sub frmOrigemActivated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConsultar.Click
        ...
        If CriterioBusca <> "XXX" Then
            ...
            dr = ds.Tables(tabela_db).Select("id = " & CriterioBusca)(0)
