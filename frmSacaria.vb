...
Friend Class frmSacaria
    Inherits System.Windows.Forms.Form
    Dim altera As Boolean
    Dim tabela_db As String = "SACARIA"
    Dim ds As New DataSet
    Dim da As New OleDbDataAdapter
    Dim dt As New DataTable
    Dim dr As DataRow
    Private Sub frmSacaria_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConsultar.Click
        ...
        Busca.Criterio(0).Campo = "ID_SACARIA"
