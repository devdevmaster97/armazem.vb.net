...
Public Class frmReportServico
    Dim oReport As New CrystalDecisions.CrystalReports.Engine.ReportDocument
    Dim da As New OleDbDataAdapter
    Dim ds As New DataSet
    Private Sub frmReportServico_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub CloseIt()
        Me.Close()
    End Sub
    Private Sub frmReportServico_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Cursor.Current = Cursors.WaitCursor
        cn = GetConnection()
        sql(0) = "SELECT * FROM qSERVICO WHERE SE = '" & frmServico.mskSE.Text & "'"
        Dim cmi As New OleDbCommand(sql(0), cn)
        da = New OleDbDataAdapter(cmi)
        da.Fill(ds, "qSERVICO")
        oReport.Load(caminhoreport & "Servico.rpt")
        ...
        CRVServico.ReportSource = oReport
