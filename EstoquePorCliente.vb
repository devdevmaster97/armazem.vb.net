...
Public Class EstoquePorCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.EstoquePorCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstoquePorCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstoquePorCliente = New EstoquePorCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
