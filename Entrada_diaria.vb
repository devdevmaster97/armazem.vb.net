...
Public Class Entrada_diaria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.Entrada_diaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DIA_ANTERIOR() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEntrada_diaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Entrada_diaria = New Entrada_diaria()
        rpt.Site = Me.Site
        Return rpt
    End Function
