...
Public Class frmFinanceiroPorMes
    Private Sub frmFinanceiroPorMes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdCarrega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCarrega.Click
        ...
        frmReportFinanceiroPorMes.Show()
    End Sub

    Private Sub frmFinanceiroPorMes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
