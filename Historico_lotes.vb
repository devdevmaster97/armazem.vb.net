...
Public Class Historico_lotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.Historico_lotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHistorico_lotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Historico_lotes = New Historico_lotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
