...
Friend Class frmOperacao
    Inherits System.Windows.Forms.Form
    Dim altera As Boolean
    Dim tabela_db As String = "OPERACAO"
    Dim ds As New DataSet
    Dim da As New OleDbDataAdapter
    Dim dt As New DataTable
    Dim dr As DataRow
    Private Sub frmOperacao_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub CloseIt()
        Me.Close()
    End Sub
    Private Sub frmOperacao_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Arquivo = tabela_db
        Me.Text = tabela_db
    ...
    Private Sub cmdConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConsultar.Click
        ...
        Busca.Criterio(0).Campo = "ID_OPERACAO"
    ...
    Private Sub txtDesc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDesc.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Then cmdSalvar.Focus()
    End Sub
