...
Public Class frmMovimentaçao_Depositante
    ...
    Private Sub btnExibir_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExibir.Click
        Dim frmTemp As frmMovimentaçao = New frmMovimentaçao(cboDepositante.Text, dtpDataInicial.Value, dtpDataFinal.Value)
        frmTemp.Show()
    End Sub
