...
Public Class frmFinanceiroGerenciaPorTipoGrid
    Private Sub frmFinanceiroGerenciaPorTipoGrid_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdCarrega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCarrega.Click
        ...
        frmReportFinanceiroGerenciaPorTipoGrid.Show()
    End Sub

    Private Sub frmFinanceiroGerenciaPorTipoGrid_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
