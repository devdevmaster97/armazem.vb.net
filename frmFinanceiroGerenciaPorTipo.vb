...
Public Class frmFinanceiroGerenciaPorTipo
    Private Sub frmFinanceiroGerenciaPorTipo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdCarrega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCarrega.Click
        ...
        frmReportFinanceiroGerenciaPorTipo.Show()
    End Sub

    Private Sub frmFinanceiroGerenciaPorTipo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
