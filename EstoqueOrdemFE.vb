...
Public Class EstoqueOrdemFE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ARMAZEM.EstoqueOrdemFE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstoqueOrdemFE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstoqueOrdemFE = New EstoqueOrdemFE()
        rpt.Site = Me.Site
        Return rpt
    End Function
