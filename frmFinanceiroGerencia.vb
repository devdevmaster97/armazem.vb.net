...
Public Class frmFinanceiroGerencia
    Private Sub frmFinanceiroGerencia_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub cmdCarrega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCarrega.Click
        ...
        frmReportFinanceiroGerencia.Show()
    End Sub

    Private Sub frmFinanceiroGerencia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
