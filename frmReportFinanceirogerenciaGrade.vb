...
Public Class frmReportFinanceirogerenciaGrade
    Dim oReport As New CrystalDecisions.CrystalReports.Engine.ReportDocument
    Dim da As New OleDbDataAdapter
    Dim ds As New DataSet
    Private Sub frmReportFinanceirogerenciaGrade_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Cursor.Current = Cursors.WaitCursor

        With frmFinanceiroGerenciaGrade
            oReport.Load(caminhoreport & "financeirogerencia.rpt")
            ...
            If dr_usuario.HasRows Then
                Do While dr_usuario.Read
                    ...
                    oReport.ParameterFields.Item(1).CurrentValues.AddValue(frmFinanceiroGerenciaGrade.dtpDataInicial.Value) 'DATA_INICIAL
                    oReport.ParameterFields.Item(2).CurrentValues.AddValue(frmFinanceiroGerenciaGrade.dtpDataFinal.Value) 'DATA_FINAL
                Loop
                cn.Close()
            End If
            '*********************************************************************
